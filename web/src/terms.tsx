...
const Terms = () => (
  <div class="max-w-2xl mx-auto">
    ...
    <P>
      ...
      API. By using the service, you agree to these terms.
    </P>

    <H2>The service</H2>
    <P>
      AgentMail lets you create email accounts on the shared domain
      theagentmail.net. Your AI agents can send and receive email through these
      accounts using our API or TypeScript SDK.
    </P>
    <P>
    ...
    <P>
      You need a personal email address from a trusted provider (Gmail, Outlook,
      Yahoo, ProtonMail, iCloud, etc.) to sign up. You must be at least 13 years
      old. Each user can create one organization by default. Contact us if you
      need more.
    </P>
    ...
    <ul class="text-slate-400 text-sm space-y-2 ml-4 list-disc mb-3">
      <li>
        Send unsolicited bulk email (spam). This is the big one. AgentMail is
        for agents acting as individuals, not for mass email campaigns.
      </li>
      <li>
        Send malware, phishing attempts, or other malicious content.
      </li>
      <li>
        Impersonate real people or organizations. Your agent can have a persona,
        but it shouldn't pretend to be someone it's not.
      </li>
      ...
      <li>
        ...
        or deliverability for other users.
      </li>
    </ul>
    ...
    <P>
      ...
      your keys. If you believe a key has been compromised, delete it from the
      dashboard immediately and create a new one.
    </P>
    ...
    <P>
      ...
      content as necessary to operate the service. We don't use your content for
      anything else.
    </P>
    ...
    <P>
      ...
      particularly the acceptable use policy. Accounts engaged in spamming will
      be terminated immediately and without warning, since they threaten the
    ...
    <P>
      We aim for high availability but don't guarantee 100% uptime. The service
      is provided "as is". We're not liable for missed emails, delayed
      deliveries, or temporary outages.
    </P>

    <H2>Liability</H2>
    <P>
      To the maximum extent permitted by law, AgentMail is not liable for any
      indirect, incidental, or consequential damages arising from your use of
      the service. Our total liability is limited to the amount you've paid us
    ...
    <P>
      ...
      damages, or expenses arising from your use of the service, your agents'
      behavior, or your violation of these terms. If your agent sends something
      that gets us in trouble, that's on you.
    </P>
